        ...
        ResultSet rst;
          try { 
                if(username.getText().isEmpty() || password.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null,"Both User name and Password are required");
                  }else{ 
                      ...
                      if(rst.next()){
                          if(rst.getString("Level").equalsIgnoreCase("admin")){
                            ...
                            staged.show(); 
                              ...
                              JOptionPane.showMessageDialog(null,"No administrator has these login credentials");
                          }
                      }else{
                          JOptionPane.showMessageDialog(null,"Wrong Login credentials used");
                      } 
                  } 
        } catch (SQLException | IOException  ex) {
                    JOptionPane.showMessageDialog(null,"A problem has occured! contact your system Administrator");
        }
